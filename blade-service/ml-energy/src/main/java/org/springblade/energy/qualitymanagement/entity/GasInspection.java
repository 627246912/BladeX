...
@AllArgsConstructor
@NoArgsConstructor
@TableName("t_sys_gas_ins")
@ApiModel(value = "SystemQualityGasInspection对象", description = "质量体系--供气")
public class GasInspection extends TenantEntity implements Serializable {
