...
@AllArgsConstructor
@NoArgsConstructor
@TableName("t_sys_ele_main")
@ApiModel(value = "SystemQualityElectricityMaintenance对象", description = "质量体系--供电保养标准")
public class ElectricityMaintenance extends TenantEntity implements Serializable {
	...
	@JsonSerialize(using = ToStringSerializer.class)
	@ApiModelProperty("设备名称编号")
	private Long devName;
